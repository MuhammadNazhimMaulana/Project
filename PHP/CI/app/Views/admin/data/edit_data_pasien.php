<div class="container">
    <div class="row">
        <div class="col-12 col-sm8- offset-sm-2 col-md-10 offset-md-1 mt-5 pt-5 pb-5 bg-white from-wrapper"> <br>
            <h1>Edit Pasien</h1>
            <br><br>
            <form action="<?= base_url("admin/edit_data_pasien"); ?>" method="post">
                <input type="hidden" class="form-control" value="<?= $pasien['id_pasien']; ?>" id="id_pasien" placeholder="Id" name="id_pasien">
                <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="jadwal_periksa" placeholder="Jadwal periksa" name="jadwal_periksa" value="<?= $pasien['jadwal_periksa']; ?>">
                </div>
                <div class="form-group">
