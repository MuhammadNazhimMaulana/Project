<div class="container">
    <div class="row">
        <div class="col-12 col-sm8- offset-sm-2 col-md-10 offset-md-1 mt-5 pt-5 pb-5 bg-white from-wrapper"> <br>
            ...
            <br><br>
            <form action="<?= base_url("admin/tambah_beli_obat"); ?>" method="post" enctype="multipart/form-data">
                <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control  <?= ($validation->hasError('jumlah_beli')) ? 'is-invalid' : ''; ?>" id="jumlah_beli" placeholder="Jumalh yang mau di beli" name="jumlah_beli">
