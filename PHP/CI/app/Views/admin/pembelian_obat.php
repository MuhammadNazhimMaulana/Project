                ...
                <tbody>
                    ...
                    <?php foreach ($Data as $row) : ?>
                        <tr>
                            ...
                            <td><a href="<?= base_url('/Admin/edit_membeli/' . $row['id_pembelian']); ?>" class="btn btn-warning mt-3">Edit</a></td>
                            <td><a href="<?= base_url('/Admin/delete_pembelian/' . $row['id_pembelian']); ?>" class="btn btn-danger mt-3" onclick="return confirm('Apakah anda yakin?');">Delete</a></td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
                </tbody>
