...
def save_image(event):
    ...
    img_temp = img.resize((28, 28))
    if(event.char == "k"):
        img_temp.save(f"Penebak Gambar/Tebak/kotak/{kotak}.png")
        kotak += 1
    elif(event.char == "l"):
        img_temp.save(f"Penebak Gambar/Tebak/lingkaran/{lingkaran}.png")
        lingkaran += 1
    elif(event.char == "s"):
        img_temp.save(f"Penebak Gambar/Tebak/segitiga/{segitiga}.png")
        segitiga += 1
